...
my @inputFile = ();
my ($sourceLang, $targetLang, $sourceFile, $targetFile, $param, $modelFolder, $metadataFile, $resultsFile);
my $threshold = "0";
my $sourceTranslationFile = "";
my $targetTranslationFile = "";
my $sourceHTMLFile = "null";
my $targetHTMLFile = "null";
my @mapping;
...
{ 
  ...
  print "     --input [targetDocsList] --output [comparabilityOutput] (--sourcetranslation \n";
  print "     --[sourceTranslationDocList] --sourcehtml [sourceHTMLList]--targettranslation\n";
  print "     [targetTranslationDocList] --targethtml [targetHTMLList] --param threshold=[minThreshold]\n";
  print "     --param model=[modelPath] --param \"mapping=[space-separated class mapping]\")\n\n";
  print "An example of use is:\n\n";
  print "     \"perl Classifier.pl --source Croatian --target English --input C:\\sourceDocs.txt --input\n";
  print "     C:\\targetDocs.txt\ --output C:\\comparabilityResult.txt --sourcetranslation C:\\List_TranslatedSourceDoc.txt\n";
  print "     --sourcehtml C:\\List_HTMLSources.txt --targettranslation C:\\List_TranslatedTargetDoc.txt --targethtml\n";
  print "     C:\\List_HTMLTargets.txt --param threshold=3\"\n";
  print "-------------------------------------------------------------------------------------------------------\n";
  exit;
}
